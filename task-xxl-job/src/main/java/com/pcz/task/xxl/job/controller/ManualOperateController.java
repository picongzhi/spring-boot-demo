package com.pcz.task.xxl.job.controller;
...
public class ManualOperateController {
    ...
    public String xxlJobGroup() {
        HttpResponse httpResponse = HttpUtil.createGet(baseUri + JOB_GROUP_URI + "/list").execute();
    ...
    public String xxlJobList(Integer page, Integer size) {
        ...
        HttpResponse httpResponse = HttpUtil.createGet(baseUri + JOB_INFO_URI + "/pageList")
                .form(jobInfo).execute();
        log.info("[response] = {}", httpResponse);
    ...
    public String xxlJobAdd() {
        ...
        jobInfo.put("executeParam", "手动添加的任务的参数");
        jobInfo.put("executeBlockStrategy", ExecutorBlockStrategyEnum.SERIAL_EXECUTION);
        jobInfo.put("glueType", GlueTypeEnum.BEAN);

        HttpResponse httpResponse = HttpUtil.createGet(baseUri + JOB_INFO_URI + "/add")
                .form(jobInfo).execute();
        log.info("[response] = {}", httpResponse);
    ...
    public String xxlJobTrigger() {
        ...
        HttpResponse httpResponse = HttpUtil.createGet(baseUri + JOB_INFO_URI + "/trigger")
                .form(jobInfo).execute();
        log.info("[response] = {}", httpResponse);
    ...
    public String xxlJobRemove() {
        ...
        HttpResponse httpResponse = HttpUtil.createGet(baseUri + JOB_INFO_URI + "/remove")
                .form(jobInfo).execute();
        log.info("[response] = {}", httpResponse);
    ...
    public String xxlJobStop() {
        ...
        HttpResponse httpResponse = HttpUtil.createGet(baseUri + JOB_INFO_URI + "/stop")
                .form(jobInfo).execute();
        log.info("[response] = {}", httpResponse);
    ...
    public String xxlJobStart() {
        ...
        HttpResponse httpResponse = HttpUtil.createGet(baseUri + JOB_INFO_URI + "/start")
                .form(jobInfo).execute();
        log.info("[response] = {}", httpResponse);
