package com.pcz.orm.jdbc.template.controller;
...
public class UserController {
    ...
    public Dict update(@RequestBody User user, @PathVariable Long id) {
        ...
        return Dict.create()
                .set("code", update ? 200 : 500)
                .set("msg", update ? "成功" : "失败")
                .set("data", update ? user : null);
    }
