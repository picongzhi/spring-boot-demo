...
public class SecondJpaConfig {
    static final String REPOSITORY_PACKAGE = "com.pcz.multi.datasource.jpa.repository.second";
    private static final String ENTITY_PACKAGE = "com.pcz.multi.datasource.jpa.entity.second";
